...
--Shorteners
	...
	cam.Start3D2D(Pos + Ang:Up() * 12.1, Ang, 0.11)
		draw.RoundedBox(0, -85, -123, 170, 245, Color(0, 0, 85, 255))
		draw.RoundedBox(0, -85, -91, 170, 32, Color(0, 85, 0, 255))
		draw.DrawText( "$"..armorboxprice, "Trebuchet24", 0, -88, Color( 255, 255, 255, 255 ), TEXT_ALIGN_CENTER )
		draw.RoundedBox(0, -85, -123, 170, 32, Color(1, 1, 1, 255))
		draw.DrawText( "Armor Box", "Trebuchet24", 0, -120, Color( 255, 255, 255, 255 ), TEXT_ALIGN_CENTER )
		draw.RoundedBox(0, -85, -59, 170, 32, Color(0, 0, 200, 255))
		draw.DrawText( "Restore to "..armorboxamount.."%", "Trebuchet24", 0, -56, Color( 255, 255, 255, 255 ), TEXT_ALIGN_CENTER )
	cam.End3D2D()
